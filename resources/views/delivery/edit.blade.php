...
<div class="box">
   <div class="box-header with-border">
      ...
      <hr>
      <form method="POST" action="{{ route('delivery.update',$delivery) }}" enctype="multipart/form-data">
         {{method_field('patch')}}
         {{ csrf_field() }}
         <div class="col-md-12">
            <div class="form-group">
               <label for="title">Condition Title</label>
               <textarea class="ckeditor form-control" name="name" id="name">{{ $delivery->name }}
               </textarea> </br>
            </div>
