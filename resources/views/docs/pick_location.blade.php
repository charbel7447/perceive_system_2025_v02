...
<section class="content" id="content">
    ...
    <table class="summary">
        ...
        <table class="items">
            <thead>
                <tr>
                    <th width="15%" style="font-size:18px;">Item Code</th>
                    <th width="15%" style="font-size:18px;">Quantity</th>
                    <th width="15%" style="font-size:18px;">Check</th>
                    <th width="65%" style="font-size:18px;">Description</th>
                    <th class="ac" width="10%" style="font-size:18px;">Location</th>
                </tr>
            </thead>
            <tbody>
                @foreach($model->items_location as $item)
                    <tr>
                        <td style="font-size:18px;">{{$item->product->code}}</td>
                        <td style="font-size:18px;">{{$item->quantity}}</td>
                        <td></td>
                        <td style="font-size:18px;">
                            <pre>{{$item->product->description}}</pre>
                        </td>
                        <td style="font-size:18px;" class="ac">{{$item->product->location}}</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td style="text-align:left;font-size:18px;">
                        <strong>{{$model->items->sum('quantity')}}</strong>
                    </td>
                    <td colspan="3"></td>
                </tr>
            </tfoot>
