...
<section class="content" id="content">
 <div class="content-title">
     ...
     <?php $ReportId1 = App\ClientPaymentReport\ClientPaymentReport::latest()->take(1)->get(); ?>
 ...
 <table class="items">
   ...
   <tbody>
      @foreach ($reports as $item)
         <tr>
            <td class="ac">
               <?php $getPRNumber = App\ClientPayment\ClientPayment::where('id','=',$item->client_payment_id)
                  ->where('status_id','>=',1)
            ...
            <td class="ac">
             @foreach ($getPRNumber as $PRNumber)
              {{moneyFormat($item->client_payments->amount_received, $PRNumber->currency, true)}}
             @endforeach
            </td>
            <td class="ac">
