    ...
    <table class="summary">
                ...
                <td class="summary-info">
                    <table class="info">
                        <tbody>
                            <tr>
                                <td>Number:</td>
                                <td>{{$model->number}}</td><br>
                            </tr>
                            <tr>
                                <td>Salary:</td>
                                <td>{{$model->employee->salary}}&nbsp;{{$model->employee->currency->code}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table class="items">
            <tbody>
                ...
                @endif
                @if($model->amount_paid_lbp)
                <tr>
                    <td>Amount Paid LBP:</td>
                    <td>{{moneyFormat($model->amount_paid_lbp, $model->currency, false)}}
                ...
                <tr>
                    ...
                    <td>{{moneyFormat($model->amount_paid + ($model->amount_paid_lbp / $model->exchangerate ), $model->currency, true)}}
                    </td>
                </tr>
                <tr>
                    <td>Description</td>
