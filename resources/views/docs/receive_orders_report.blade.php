...
<section class="content" id="content">
    <div class="content-title">
        ...
        <?php $ReportId1 = App\ReceiveOrderReport\ReceiveOrderReport::latest()->take(1)->get(); ?>
    ...
    <table class="items">
      ...
      <tbody>
         @foreach ($reports as $item)
            <tr>
               <td class="ac">
                <?php $getPRNumber = App\ReceiveOrder\ReceiveOrder::with(['items'])
                    ->where('id','=',$item->receive_order_id)
        ...
        <tr class="ar">
            ...
            <td colspan="1"  class="ar">
              <?php  $sum = 0; ?>
                ...
                <?php $quantity = $variants['received_qty'];
                    $act_points = $quantity;
                    $sum += $act_points; ?>
                @endforeach
               {{$sum}}
