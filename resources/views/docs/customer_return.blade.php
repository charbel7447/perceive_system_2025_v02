                    ...
                    <table class="info">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$model->invoiceOrder->number}}</td>
                            </tr>
                            @if($model->reference)
                            <tr>
                                <td>Reference:</td>
            ...
            <tbody>
                @foreach($model->items as $item)
                    <tr>
                        ...
                        <td class="ac">{{$item->qty_returned}}</td>
                        <td class="ac">
                        <?php $getuom = App\Product\Product::where('code','=',$item->product->code)->get(); ?>
                        @foreach ($getuom as $uomu)
                        <?php $getuomname = App\Uom::where('id','=',$uomu->uom_id)->get(); ?>
                        @foreach ($getuomname as $uomun)
                        {{$uomun->unit}}
                        @endforeach
                        @endforeach
                        </td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td colspan="2" style="text-align:center;">
                        <strong>{{$model->items->sum('qty_returned')}}</strong>
                    </td>
                </tr>
            </tfoot>
    </table>
