...
<section class="content" id="content">
 <div class="content-title">
    Credit Notes Report
     <?php $ReportId1 = App\CreditNoteReport\CreditNoteReport::latest()->take(1)->get(); ?>
 ...
 <table class="items">
   ...
   <tbody>
      @foreach ($reports as $item)
         <tr>
            <td class="ac">
               <?php $getPRNumber = App\CreditNote\CreditNote::where('id','=',$item->credit_note_id)
                  ->where('status_id','>=',1)
            ...
            <td class="ac">
             @foreach ($getPRNumber as $PRNumber)
              {{moneyFormat($item->credit_notes->amount_received, $PRNumber->currency, true)}}
             @endforeach
            </td>
            <td class="ac">
