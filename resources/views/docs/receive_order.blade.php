        ...
        <table class="items">
            <thead>
                <tr>
                    ...
                    <th class="ac" width="10%">PO Qty</th>
                    <th class="ac" width="10%">Purchase UOM</th>
                    <th class="ac" width="10%">Received Qty</th>
                    <th class="ac" width="10%">Received UOM</th>
                </tr>
            </thead>
            <tbody>
                @foreach($model->items as $item)
                    <tr>
                        ...
                        <td class="ac">{{$item->purchase_qty}}</td>
                        <td class="ac">{{$item->uom_code}}</td>
                        <td class="ac">{{$item->qty}}</td>
                        <td class="ac">{{$item->received_uom_code}}</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
