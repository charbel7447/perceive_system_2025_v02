...
<section class="content" id="content">
 <div class="content-title">
    Quotations Report
     <?php $ReportId1 = App\QuotationReport\QuotationReport::latest()->take(1)->get(); ?>
 ...
 <table class="items">
   <thead>
       <tr>
           <th class="ac" >Quotation-Number</th>
   ...
   <tbody>
      @foreach ($reports as $item)
         <tr>
            <td class="ac">
               <?php $getPRNumber = App\Quotation\Quotation::where('id','=',$item->quotation_id)
                  ->where('status_id','>',1)
            ...
            <td class="ac">
             @foreach ($getPRNumber as $PRNumber)
              {{moneyFormat($item->quotations->total, $PRNumber->currency, true)}}
             @endforeach
            </td>
            <td class="ac">
               @foreach ($getPRNumber as $PRNumber)
