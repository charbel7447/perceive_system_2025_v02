...
<section class="content" id="content">
 <div class="content-title">
    Sales Orders Report
     <?php $ReportId1 = App\SalesOrderReport\SalesOrderReport::latest()->take(1)->get(); ?>
 ...
 <table class="items">
   ...
   <tbody>
      @foreach ($reports as $item)
         <tr>
            <td class="ac">
               <?php $getPRNumber = App\SalesOrder\SalesOrder::where('id','=',$item->sales_order_id)
                  ->where('status_id','>',2)
            ...
            <td class="ac">
             @foreach ($getPRNumber as $PRNumber)
              {{moneyFormat($item->sales_orders->total, $PRNumber->currency, true)}}
             @endforeach
            </td>
            <td class="ac">
               @foreach ($getPRNumber as $PRNumber)
