<table class="items">
   ...
   <tbody>
    <?php $reports = \App\SalesOrderReport\Item::where('report_id','=',$id)->get(); ?>
      @foreach ($reports as $item)
        <?php
            $number = App\SalesOrder\SalesOrder::where('id','=',$item->sales_order_id)->value('number'); 
            $client_id = App\SalesOrder\SalesOrder::where('id','=',$item->sales_order_id)->value('client_id'); 
            ...
            $date = App\SalesOrder\SalesOrder::where('id','=',$item->sales_order_id)->value('date'); 
