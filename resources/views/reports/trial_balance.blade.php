...
<div class="container-fluid p-4">
    <div class="card p-4">
        ...
        <!-- Filter Form -->
        <form method="GET" action="{{ route('reports.trial_balance') }}" class="mb-4">
            <div class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="account_id" class="form-control select2">
                        ...
                        @foreach(\App\ChartOfAccount::all() as $account)
        ...
        <div class="mb-3">
            <a href="{{ route('reports.trial_balance.export', request()->all()) }}" class="btn btn-success fw-bold">
