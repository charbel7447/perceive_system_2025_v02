    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                ...
                <span class="logo-mini"> <img src="/images/polyxpert-logo.png" /></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"> <img src="/images/polyxpert-logo.png" /></span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar" style="background-color:#222d32 "> 
                ...
                <!-- Sidebar Menu -->
                <ul class="sidebar-menu" data-widget="tree"  style="background-color: #222d32">
