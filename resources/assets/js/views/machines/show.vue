    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                ...
                <div>
                    <router-link :to="`/machines`" class="btn" title="Go Back">
                        <i class="fa fa-arrow-left"></i>
                    </router-link>
                    <router-link :to="`/machines/${model.id}/edit`"
    ...
    export default {
        ...
        methods: {
            deleteModel() {
                ...
                if(r != true) { return }
                this.$bar.start()
                byMethod('delete', `/api/machines/${this.model.id}`)
                    .then(({data}) => {
                        if(data.deleted) {
            ...
            setData(res) {
                ...
                this.$title.set(`machines - ${this.model.text}`)
                this.$bar.finish()
                this.show = true
            }
        }
