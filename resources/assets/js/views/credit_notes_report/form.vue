    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Credit Notes</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/credit_notes_report/create`,
            'edit': `/api/credit_notes_report/${to.params.id}/edit`,
            'clone': `/api/credit_notes_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/credit_notes_report',
                store: '/api/credit_notes_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/credit_notes_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`credit_notes_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
