    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Transfer Account</span>
            </div>
                ...
                <div class="row">
                    <div class="col col-3">
                        <div class="form-group">
                            ...
                            <error-text :error="error.transfer_date"></error-text>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/transfer_accounts/create`
        }
    ...
    export default {
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Transfer Account ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
