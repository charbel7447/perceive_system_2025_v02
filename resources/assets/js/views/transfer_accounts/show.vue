    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">Tansfer {{model.number}}</span>
                <div>
                    <router-link :to="`/transfer_accounts`" class="btn" title="Go Back">
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get(`/api/transfer_accounts/${to.params.id}`)
                .then(res => {
        ...
        methods: {
            setData(res) {
                ...
                this.$title.set(`transfer_accounts - ${this.model.number}`)
                this.$bar.finish()
                this.show = true
            },
        }
