...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/product_dropdown_2/create`,
            'edit': `/api/product_dropdown_2/${to.params.id}/edit`,
            'clone': `/api/product_dropdown_2/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/product_dropdown_2',
                store: '/api/product_dropdown_2',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/product_dropdown_2/${this.$route.params.id}`
