    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Vat Rate</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/vatrate/create`,
            'edit': `/api/vatrate/${to.params.id}/edit`,
            'clone': `/api/vatrate/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/vatrate/${this.$route.params.id}`
                this.message = 'You have successfully updated vatrate!'
                this.method = 'PUT'
                this.title = 'Edit'
            }
        },
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Vat Rate ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
