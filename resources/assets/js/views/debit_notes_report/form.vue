    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Debit Notes</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/debit_notes_report/create`,
            'edit': `/api/debit_notes_report/${to.params.id}/edit`,
            'clone': `/api/debit_notes_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/debit_notes_report',
                store: '/api/debit_notes_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/debit_notes_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`debit_notes_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
