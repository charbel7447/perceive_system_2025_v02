    ...
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">List Of Products</span>
              <tr  style="text-align:center;" slot-scope="props" @click="$router.push(`${resource}/${props.item.id}/division`)">
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/products_division', to.query)
                .then(res => {
        ...
        methods: {
            setData(res) {
                this.$title.set('Products Divison')
