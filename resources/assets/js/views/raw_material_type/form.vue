...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/raw_material_type/create`,
            'edit': `/api/raw_material_type/${to.params.id}/edit`,
            'clone': `/api/raw_material_type/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/raw_material_type/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`raw_material_type ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
