    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">Returned Deposit {{model.number}}</span>
                <div>
                    <router-link :to="`/return_deposits`" class="btn" title="Go Back">
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get(`/api/return_deposits/${to.params.id}`)
                .then(res => {
        ...
        methods: {
            setData(res) {
                ...
                this.$title.set(`return_deposits - ${this.model.number}`)
                this.$bar.finish()
                this.show = true
            },
        }
