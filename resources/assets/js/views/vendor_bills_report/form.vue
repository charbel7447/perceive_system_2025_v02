    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Vendor Bills</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/vendor_bills_report/create`,
            'edit': `/api/vendor_bills_report/${to.params.id}/edit`,
            'clone': `/api/vendor_bills_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/vendor_bills_report',
                store: '/api/vendor_bills_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/vendor_bills_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`vendor_bills_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
