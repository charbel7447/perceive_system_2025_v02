    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- advance_payments_report</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/advance_payments_report/create`,
            'edit': `/api/advance_payments_report/${to.params.id}/edit`,
            'clone': `/api/advance_payments_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/advance_payments_report',
                store: '/api/advance_payments_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/advance_payments_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`advance_payments_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
