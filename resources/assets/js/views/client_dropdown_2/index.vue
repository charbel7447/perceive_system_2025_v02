<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">{{client_dropdown_2}} DropDown Table</span>
            <router-link  slot="create" to="/client_dropdown_2/create" class="btn btn-primary">
                New
            </router-link>
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/client_dropdown_2', to.query)
                .then(res => {
