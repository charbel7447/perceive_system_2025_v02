<template>
    <div>
          <router-link style="display:none" slot="create" to="/docs/subsubcategories"
                        class="btn btn-primar" title="Report" target="_blank">
                        <i class="fa fa-download"></i>
           </router-link>

            <a style="display:none" slot="create" href="docs/subsubcategories" target="_blank" class="btn" title="View PDF">
                            <i class="fa fa-file-pdf-o"></i>
           </a>
           
           
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Sub SubCategory</span>
            <router-link slot="create" to="/subsubcategories/create" class="btn btn-primary" >
                New
            </router-link>
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/subsubcategories', to.query)
                .then(res => {
