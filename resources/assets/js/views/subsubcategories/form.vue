    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Sub Sub Category</span>
            </div>
                ...
                <div class="row">
                    <div class="col col-4">
                        ...
                        <div class="form-group">
                            ...
                            <typeahead required :initial="form.parent"
                                :url="subcategoryURL"
                                @input="onSubCategoryUpdate"
                            >
                            </typeahead>
                            <input style="display: none;" type="text" class="form-control" v-model="form.category_id">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <span class="form-control">{{form.category_code}}-{{form.number}}</span>
                            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/subsubcategories/create`,
            'edit': `/api/subsubcategories/${to.params.id}/edit`,
            'clone': `/api/subsubcategories/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/subsubcategories/${this.$route.params.id}`
        ...
        methods: {
            ...
            onSubCategoryUpdate(e) {
                ...
                Vue.set(this.form, 'sub_category_id', parent.id)
                Vue.set(this.form, 'parent', parent)
                Vue.set(this.form, 'category_code', parent.number)
            },
            setData(res) {
