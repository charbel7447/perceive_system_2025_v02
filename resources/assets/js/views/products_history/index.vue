<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">products_history</span>
            <router-link slot="create" to="products_history_report/create"
                        class="btn btn-primar"  title="Report" target="_blank">
                     Report&nbsp;&nbsp;&nbsp;<i class="fa fa-file-pdf-o"></i>
           </router-link>
            <router-link slot="create" to="/products_history/create" class="btn btn-primary">
                New 
            </router-link>
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/products_history', to.query)
                .then(res => {
        ...
        methods: {
            setData(res) {
                this.$title.set(`products_history`)
