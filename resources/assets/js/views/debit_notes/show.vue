    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">Debit Note {{model.number}}</span>
                <div>
                    ...
                    <router-link :to="`/debit_notes`" class="btn" title="Go Back">
                        <i class="fa fa-arrow-left"></i>
                    </router-link>
                    <!-- <router-link :to="`/email/${model.id}/debit_notes`" class="btn btn-primary" title="Sent Email">
                        <i class="fa fa-envelope-o"></i>
                    </router-link> -->
                    <div class="btn-group">
                        <a :href="`/docs/debit_notes/${model.id}`" target="_blank" class="btn" title="View PDF">
                            <i class="fa fa-file-pdf-o"></i>
                        </a>
                        <a :href="`/docs/debit_notes/${model.id}?mode=download`" target="_blank" class="btn" title="Download PDF">
                    ...
                    <div class="document-body">
                        ...
                        <div class="row">
                            <div class="col col-8">
                                ...
                                <strong>Debit Amount Received</strong><br>
                        ...
                        <table class="document-table" v-if="model.items.length">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="1"></td>
                                    <td colspan="2">
                                        <strong>Debit Amount Received {{first_currency}}</strong>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="1"></td>
                                    <td colspan="2">
                                        <strong>Debit Amount Received {{second_currency}}</strong>
                                    </td>
                                    <td class="align-right">
                                        <strong>
...
<script type="text/javascript">
    ...
    import ApplyInvoices from '../../components/modals/ApplyDebit.vue'
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get(`/api/debit_notes/${to.params.id}`)
                .then(res => {
        ...
        methods: {
            setData(res) {
                ...
                this.$title.set(`Debit Note - ${this.model.number}`)
                this.$bar.finish()
                this.show = true
            }
        }
