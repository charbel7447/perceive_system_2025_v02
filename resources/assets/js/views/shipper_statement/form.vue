    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} shipper_statement</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/shipper_statement/create`,
            'edit': `/api/shipper_statement/${to.params.id}/edit`,
            'clone': `/api/shipper_statement/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                ...
                store: '/api/shipper_statement',
                method: 'POST',
                title: 'Create',
                message: 'You have successfully created shipper_statement!',
                currencyURL: '/api/search/currencies'
            }
        },
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/shipper_statement/${this.$route.params.id}`
                this.message = 'You have successfully created your shipper_statement!'
                this.method = 'PUT'
                this.title = 'Edit'
            }
        },
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`shipper_statement ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
