<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Shippment Receive Orders</span>
            <router-link  slot="create" to="container_receive_orders_report/create"
                        class="btn btn-primar"  title="Report" target="_blank">
                     Report By Criteria &nbsp;&nbsp;&nbsp;<i class="fa fa-file-pdf-o"></i>
           </router-link>
           <router-link slot="create" to="container_receive_orders_report/show"
                        class="btn btn-primar"  title="Report" target="_blank">
            ...
            <tr slot-scope="props" @click="$router.push(`${resource}/${props.item.id}`)">
                    ...
                    <td class="width-6" :title="props.item.shipper.text">
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/container_receive_orders', to.query)
                .then(res => {
