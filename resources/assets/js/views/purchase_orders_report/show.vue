    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Purchase Orders</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/purchase_orders_report/create`,
            'edit': `/api/purchase_orders_report/${to.params.id}/edit`,
            'clone': `/api/purchase_orders_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/purchase_orders_report',
                store: '/api/purchase_orders_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/purchase_orders_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`purchase_orders_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
