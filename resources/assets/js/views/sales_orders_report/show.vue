...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/sales_orders_report/create`,
            'edit': `/api/sales_orders_report/${to.params.id}/edit`,
            'clone': `/api/sales_orders_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/sales_orders_report',
                store: '/api/sales_orders_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/sales_orders_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`sales_orders_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
