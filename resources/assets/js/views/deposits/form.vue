    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Deposit</span>
            </div>
                ...
                <div class="row">
                    <div class="col col-3">
                        <div class="form-group">
                            ...
                            <error-text :error="error.deposit_date"></error-text>
                        </div>
                    </div>
                </div>
                <div class="row">
                 <div class="col col-3">
                    ...
                    <div class="col col-3">
                        <div class="form-group">
                            ...
                            <typeahead :initial="form.to_account"
                                :url="accountURL"
                                @input="onToAccountUpdate"
                            >
                            </typeahead>
                            <error-text :error="error.to_account_id"></error-text>
                        </div>
                    </div>
                </div>
                <div class="row">
                 <div class="col col-3">
                        <div class="form-group">
                            <label>Transfer Amount <small v-if="form.to_account_id === 1">Amount in {{first_currency}}</small>
                            <small v-if="form.to_account_id === 2">Amount in {{second_currency}}</small></label>
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            onToAccountUpdate(e) {
                const to_account = e.target.value

                Vue.set(this.form, 'to_account_id', to_account.id)
                Vue.set(this.form, 'to_account', to_account)
            },
            setData(res) {
