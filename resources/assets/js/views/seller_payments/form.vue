            ...
            <div class="panel-body">
                    ...
                    <div class="col col-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="form.payment_mode">
                                ...
                                <option value="Transfer_to_ETHYDCO">Transfer to ETHYDCO</option>
                ...
                <div class="row">
                    <div class="col col-3">
                         ...
                         <!-- <div class="form-group">
                             <label>Amount Paid LBP <small> in USD</small></label>
                            ...
                            <!--  <td class="width-2">
                                ...
                                <tr v-if="form.lbpAccount">
                                            <td class="width-6" style="padding:15px 0px;">
                                               <strong>  Amount Applied LBP <small  style="float: right;0 0px 0 55px
    font-size: 55%;
    margin: 0 10px;">Default Value 0</small></strong>
                                        ...
                                        <!-- <tr v-if="form.lbpAccount">
                                            <td class="width-6" style="padding:10px 0px;">
                                                 <strong> VAT LBP <small style="float: right;0 0px 0 55px
    font-size: 55%;
    margin: 0 10px;">Default Value 0</small> </strong>
                                            </td>
                                        </tr>
                            ...
                            <td :class="['width-3']">
                                        ...
                                        <!-- <tr v-if="form.lbpAccount">
                                            ...
                                            <td class="width-2" style="font-weight: bold;font-size: 10px;">LBP Rate</td>
