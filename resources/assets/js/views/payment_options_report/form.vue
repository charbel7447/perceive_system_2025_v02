    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Payment Options</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/payment_options_report/create`,
            'edit': `/api/payment_options_report/${to.params.id}/edit`,
            'clone': `/api/payment_options_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/payment_options_report',
                store: '/api/payment_options_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/payment_options_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`payment_options_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
