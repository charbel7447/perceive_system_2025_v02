    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                ...
                <div>
                    <router-link :to="`/subcategories`" class="btn" title="Go Back">
                        <i class="fa fa-arrow-left"></i>
                    </router-link>
                    <router-link :to="`/subcategories/${model.id}/edit`"  
                        class="btn" title="Edit">
                        <i class="fa fa-pencil"></i>
                    </router-link>
                      <router-link :to="`/docs/subcategories/${model.id}/`"
...
<script type="text/javascript">
    ...
    export default {
        ...
        data() {
            return {
                show: false,
                productURL: `/api/mini/subcategories/products/${this.$route.params.id}`,
        ...
        beforeRouteEnter(to, from, next) {
            get(`/api/subcategories/${to.params.id}`)
                .then(res => {
        ...
        methods: {
            deleteModel() {
                ...
                if(r != true) { return }
                this.$bar.start()
                byMethod('delete', `/api/subcategories/${this.model.id}`)
                    .then(({data}) => {
                        if(data.deleted) {
