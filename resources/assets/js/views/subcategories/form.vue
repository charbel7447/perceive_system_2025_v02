    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Sub Category</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            ...
            'edit': `/api/subcategories/${to.params.id}/edit`,
            'clone': `/api/subcategories/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/subcategories/${this.$route.params.id}`
        ...
        methods: {
            ...
            onCategoryUpdate(e) {
                ...
                Vue.set(this.form, 'category_id', parent.id)
