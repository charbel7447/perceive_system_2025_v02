    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Invoices</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/invoices_report/create`,
            'edit': `/api/invoices_report/${to.params.id}/edit`,
            'clone': `/api/invoices_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/invoices_report',
                store: '/api/invoices_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/invoices_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`invoices_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
