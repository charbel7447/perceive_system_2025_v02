    ...
    <div v-if="show">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <hr>
                <div class="row">
                    <div class="col col-3" v-if="form.usdAccount">
                         <div class="form-group">
                             <label>Amount Received {{first_currency}}</label>
                             <input type="text" class="form-control" v-model="form.amount_received_usd">
                             <error-text :error="error.amount_received_usd"></error-text>
                         </div>
                    </div>
                    <div class="col col-3" v-if="form.lbpAccount">
                         <div class="form-group">
                             <label>Amount Received {{second_currency}}</label>
    ...
    export default {
        ...
        data () {
            return {
                ...
                paymentOptionURL: '/api/search/cn_payment_options',
            }
        },
