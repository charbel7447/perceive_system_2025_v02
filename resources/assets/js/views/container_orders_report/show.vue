    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Shippment Orders</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/container_orders_report/create`,
            'edit': `/api/container_orders_report/${to.params.id}/edit`,
            'clone': `/api/container_orders_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/container_orders_report',
                store: '/api/container_orders_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/container_orders_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`container_orders_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
