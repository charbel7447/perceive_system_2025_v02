    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} seller_statement</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/seller_statement/create`,
            'edit': `/api/seller_statement/${to.params.id}/edit`,
            'clone': `/api/seller_statement/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                ...
                store: '/api/seller_statement',
                method: 'POST',
                title: 'Create',
                message: 'You have successfully created seller_statement!',
                currencyURL: '/api/search/currencies'
            }
        },
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/seller_statement/${this.$route.params.id}`
                this.message = 'You have successfully created your seller_statement!'
                this.method = 'PUT'
                this.title = 'Edit'
            }
        },
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`seller_statement ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
