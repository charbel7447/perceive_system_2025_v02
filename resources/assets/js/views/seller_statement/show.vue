    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">seller_statement</span>
                 <span class="panel-title">{{model.text}}</span>
                <div>
                    <router-link :to="`/seller_statement`" class="btn" title="Go Back">
                        <i class="fa fa-arrow-left"></i>
                    </router-link>
                    <router-link :to="`/seller_statement/${model.id}/edit`"
                        class="btn btn-dangerx" title="Export">
                        ...
                        <div class="stats">
                            <div class="stat">
                                <div class="stat-inner">
                                    <h2 class="stat-title">Total Due</h2>
    ...
    export default {
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Seller - ${this.model.text}`)
                this.$bar.finish()
                this.show = true
            }
        }
