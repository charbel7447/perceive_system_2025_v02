<template>
    <div>
          <router-link style="display:none" slot="create" to="/docs/warehousesreports"
                        class="btn btn-primar" title="Report" target="_blank">
                        <i class="fa fa-download"></i>
           </router-link>

            <a style="display:none" slot="create" href="docs/warehousesreports" target="_blank" class="btn" title="View PDF">
                            <i class="fa fa-file-pdf-o"></i>
           </a>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Warehouses</span>
            <router-link    slot="create" to="/warehouses/create" class="btn btn-primary">
                New 
            </router-link>
        ...
        data() {
            return {
                ...
                heading: [
                    ...
                    {title: 'Warehouse Code', name: 'number', sort: true},
