    ...
    export default {
        ...
        methods: {
            ...
            search() {
                ...
                this.$router.push(`sales_orders/filter?client_name=${this.client_name}&from_date=${this.from_date}&to_date=${this.to_date}&amount=${this.amount}&client_dropdown1=${this.client_dropdown1}&client_dropdown2=${this.client_dropdown2}&client_seller=${this.client_seller}`);
            },
            setData(res) {
