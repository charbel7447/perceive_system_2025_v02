                ...
                <div class="row">
                    ...
                    <div class="col col-3" v-if="(form.seller_commission > 0)">
                        <div class="form-group">
                            ...
                            <input disabled type="text" class="form-control" v-model="form.seller_commission">
                ...
                <table class="item-table">
                    ...
                    <tbody>
                        <template v-for="(item, index) in form.items">
                            <tr>
                                <td :class="['width-7', errors(`items.${index}.item_id`)]">
                                ...
                                <td :class="['width-2', errors(`items.${index}.location`)]" style="display: none;">
                                    <input type="text" class="form-control" v-model="item.location">
                                    <error-text :error="error[`items.${index}.location`]"></error-text>
                                </td>
                            ...
                            <tr class="item-tax">
                                <td colspan="1" v-if="item.cost_price > item.price">
                            ...
                            <tr class="item-tax" v-if="item.taxes.length && ( form.vat_status == 1 )" v-for="tax in item.taxes">
                                <td colspan="2" v-if="display_vat == 1">Vat +{{(Number(item.quantity * Number(item.price)* Number(form.vatrate)  ) * tax.rate / 100) | formatMoney(form.currency, false) }}{{second_currency}}</td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="item-footer" colspan="2"><b>Discount</b> (Fixed Amount)</td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="item-footer" colspan="2"><b>Shipping</b> (Fixed Amount)</td>
                            <td class="item-footer" colspan="2" style="">
    ...
    export default {
        ...
        methods: {
            ...
            onClientUpdate(e) {
                ...
                Vue.set(this.form, 'sellerx_id', client.seller_id)
                Vue.set(this.form, 'seller_id', client.seller_id)
            ...
            onProductUpdated(item, index, e) {
                ...
                Vue.set(this.form.items[index], 'location', product.location)
                // taxes
