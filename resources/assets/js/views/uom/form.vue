    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Units Of Measurments</span>
            </div>
                ...
                <div class="row">
                    <div class="col col-4">
                        <div class="form-group">
                            ...
                            <error-text :error="error.unit"></error-text>
                        </div>
                <hr>
            </div>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/uom/create`,
            'edit': `/api/uom/${to.params.id}/edit`,
            'clone': `/api/uom/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/uom/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Unit Of Measurment ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
