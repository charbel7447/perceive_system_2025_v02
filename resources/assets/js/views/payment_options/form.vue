    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Payment Option</span>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col col-4">
                        <div class="form-group">
                            <label>Option Balance USD</label>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/payment_options/create`,
            'edit': `/api/payment_options/${to.params.id}/edit`,
            'clone': `/api/payment_options/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                ...
                store: '/api/payment_options',
                method: 'POST',
                title: 'Create',
                message: 'You have successfully created payment_options!',
            }
        },
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/payment_options/${this.$route.params.id}`
                this.message = 'You have successfully updated payment_options!'
                this.method = 'PUT'
                this.title = 'Edit'
            }
        },
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Payment Option ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
