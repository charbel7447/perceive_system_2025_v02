    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Vendor Expenses</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/expenses_report/create`,
            'edit': `/api/expenses_report/${to.params.id}/edit`,
            'clone': `/api/expenses_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/expenses_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`expenses_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
