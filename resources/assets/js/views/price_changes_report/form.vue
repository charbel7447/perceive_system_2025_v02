    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Product Prices Variation</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/price_changes_report/create`,
            'edit': `/api/price_changes_report/${to.params.id}/edit`,
            'clone': `/api/price_changes_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/price_changes_report',
                store: '/api/price_changes_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/price_changes_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`price_changes_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
