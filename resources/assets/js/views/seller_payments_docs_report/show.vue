    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Custom Report -- Seller Payments By Clients</span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/seller_payments_docs_report/create`,
            'edit': `/api/seller_payments_docs_report/${to.params.id}/edit`,
            'clone': `/api/seller_payments_docs_report/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/seller_payments_docs_report',
                store: '/api/seller_payments_docs_report',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/seller_payments_docs_report/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`seller_payments_docs_report ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
