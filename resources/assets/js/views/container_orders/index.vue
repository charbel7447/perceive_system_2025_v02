<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Shipping Orders</span>
            <router-link slot="create" to="container_orders_report/create"
                        class="btn btn-primar"  title="Report" target="_blank">
                     Report By Criteria &nbsp;&nbsp;&nbsp;<i class="fa fa-file-pdf-o"></i>
           </router-link>
           <router-link slot="create" to="container_orders_report/show"
                        class="btn btn-primar"  title="Report" target="_blank">
                     Report By Criteria &nbsp;&nbsp;&nbsp;<i class="fa fa-file-excel-o"></i>
           </router-link>
            <router-link slot="create" to="/container_orders/create" class="btn btn-primary">
                New Shipping Order
            </router-link>
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/container_orders', to.query)
                .then(res => {
