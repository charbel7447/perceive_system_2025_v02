    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Third Parties / Extras</span>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-4">
                        <div class="form-group">
                            ...
                            <error-text :error="error.number"></error-text>
                        </div>
                    </div>
                    <div class="col col-4">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/third_parties_extras/create`,
            'edit': `/api/third_parties_extras/${to.params.id}/edit`,
            'clone': `/api/third_parties_extras/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                ...
                store: '/api/third_parties_extras',
                method: 'POST',
                title: 'Create',
                message: 'You have successfully created  Third Parties / Extras!',
                currencyURL: '/api/search/currencies'
            }
        },
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/third_parties_extras/${this.$route.params.id}`
                this.message = 'You have successfully updated Third Parties / Extras!'
                this.method = 'PUT'
                this.title = 'Edit'
            }
        },
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Third Parties / Extras ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
