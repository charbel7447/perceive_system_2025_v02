<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Payment Condition</span>
            <router-link slot="create" to="/paymentcondition/create" class="btn btn-primary">
                New 
            </router-link>
...
<script type="text/javascript">
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            get('/api/paymentcondition', to.query)
                .then(res => {
        ...
        methods: {
            setData(res) {
                this.$title.set('Payment condition')
