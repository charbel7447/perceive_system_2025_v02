    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{client_dropdown_1}} {{title}} </span>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/client_dropdown_1/create`,
            'edit': `/api/client_dropdown_1/${to.params.id}/edit`,
            'clone': `/api/client_dropdown_1/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        data () {
            return {
                resource: '/client_dropdown_1',
                store: '/api/client_dropdown_1',
                method: 'POST',
                title: 'Create',
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/client_dropdown_1/${this.$route.params.id}`
