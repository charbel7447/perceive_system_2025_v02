<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Credit Notes</span>
            <router-link slot="create" to="credit_notes_report/create"
                            class="btn btn-primar"  title="Report" target="_blank">
                        Report &nbsp;&nbsp;&nbsp;<i class="fa fa-file-pdf-o"></i>
            </router-link>
     
            <router-link slot="create" to="/credit_notes/create" class="btn btn-primary">
                New 
            </router-link>
        ...
        data() {
            return {
                ...
                heading: [
                    ...
                    {title: 'Credit Amount', name: 'amount_received', sort: true},
