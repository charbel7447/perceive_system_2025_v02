    ...
    <div v-if="show">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{title}} Credit Notes</span>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col col-3" >
                         <div class="form-group">
                             <label>Credit Amount {{first_currency}}</label>
                    ...
                    <div class="col col-3"  v-if="display_exchange_rate == 1" >
                         <div class="form-group">
                             <label>Credit Amount {{second_currency}}</label>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/credit_notes/create`
        }
    ...
    export default {
        ...
        data () {
            return {
                ...
                store: '/api/credit_notes',
                method: 'POST',
                title: 'Receive',
                message: 'You have successfully received credit_notes!',
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Credit Note ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
