...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            'create': `/api/vat_accounts/create`,
            'edit': `/api/vat_accounts/${to.params.id}/edit`,
            'clone': `/api/vat_accounts/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        created() {
            if(this.mode === 'edit') {
                this.store = `/api/vat_accounts/${this.$route.params.id}`
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`vat_accounts ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
