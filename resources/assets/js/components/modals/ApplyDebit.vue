        ...
        <div class="modal-mask">
            <div class="modal-wrapper">
                <div class="modal-container">
                    <div class="modal-heading">Apply Debit Payment to Invoices</div>
...
<script type="text/javascript">
    ...
    export default {
        ...
        data() {
            return {
                resource: `/debit_notes/${this.$route.params.id}`,
                url: `/api/search/debit_notes_invoices/${this.$route.params.id}`,
                store: `/api/debit_notes_invoices/${this.$route.params.id}/apply`,
                method: 'POST',
