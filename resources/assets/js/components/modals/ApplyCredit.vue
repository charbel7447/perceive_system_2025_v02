        ...
        <div class="modal-mask">
            <div class="modal-wrapper">
                <div class="modal-container">
                    <div class="modal-heading">Apply Credit Payment to Invoices</div>
                        ...
                        <div class="row">
                            <div class="col col-4">
                                <div class="form-group">
                                    ...
                                    <span class="form-control">{{Number(form.balance) | formatMoney(form.currency, false)}}</span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-footer">
                                            <strong class="item-dark form-control">
                                                {{form.balance | formatMoney(form.currency)}}
                                            </strong>
...
<script type="text/javascript">
    ...
    export default {
        ...
        data() {
            return {
                resource: `/credit_notes/${this.$route.params.id}`,
                url: `/api/search/credit_notes_invoices/${this.$route.params.id}`,
                store: `/api/credit_notes_invoices/${this.$route.params.id}/apply`,
                method: 'POST',
