...
class Shipper extends Model
{
    ...
    protected $search = [
        ...
        'billing_address', 'shipping_address', 'payment_details','vat_status','container_size'
    ];

    protected $columns = [
        'id', 'person', 'company', 'email', 'mobile_number',
        'work_phone', 'billing_address', 'shipping_address', 'payment_details',
        'total_revenue', 'created_at','vat_number','vat_status','container_size'
    ];

    protected $fillable = [
        'person', 'company', 'email', 'mobile_number', 'work_phone',
        'billing_address', 'shipping_address', 'payment_details',
        'currency_id','vat_number','vat_status','container_size'
    ];
    ...
    public function shipperbills()
    {
        return $this->hasMany(ShipperBill::class);
    }
    ...
    {
        return $this->hasMany(ProductItem::class, 'shipper_id', 'id');
    }
