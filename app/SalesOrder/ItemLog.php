...
class ItemLog extends Model
{
   // protected $table = 'sales_order_items';
    ...
    protected $table = 'sales_order_items_log';

    protected $fillable = [
        'item_id', 'quantity', 'price','uom_id','uom_code','location','product_name',
    ];
    ...
    {
        return $this->hasMany(TaxLog::class, 'sales_order_item_id', 'id');
    }

    public function uom()
    {
        return $this->hasMany(Uom::class, 'unit','uom');
    }
