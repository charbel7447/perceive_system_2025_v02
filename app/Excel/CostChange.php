...
class CostChange implements FromView,WithStyles,WithTitle,WithEvents,WithColumnFormatting
{
    use Exportable;
    public $id;
...
//Heading formatting...
				$event->getSheet()->getDelegate()->getStyle('A2:C2')->applyFromArray($styleArray1);

                $event->getSheet()->getDelegate()->getStyle('A1:C1')->applyFromArray($styleArray8);

                $event->getSheet()->getDelegate()->getStyle('A1:C1')->applyFromArray($styleArray4);
    ...
    {
    //    dd($this->id);
        return view('home.cost_change_report', [
            'id' => $this->id
        ]);
    }
}