...
class ClientsTable implements FromView, WithStyles, WithTitle, WithEvents, WithColumnFormatting
{
    use Exportable;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A1:BH1')->getFont()->setBold(true)->setSize(12);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                foreach (range('AA', 'BH') as $col) {
                    $sheet->getColumnDimension($col)->setAutoSize(true);
                }

                // Add auto filter to the header row
                $sheet->setAutoFilter('A1:BH1');
            },
        ];
    }
    ...
    {
        return view('home.clients_table');
    }
}
