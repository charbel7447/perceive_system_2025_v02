...
class AdvancePayment extends Model
{
    ...
    protected $columns = [
        ...
        'amount_received', 'description', 'created_at','amount_received_usd','exchangerate','amount_received_lbp',
        'payment_option_id'
    ];

    protected $fillable = [
        'user_id','client_id', 'currency_id', 'payment_date', 'payment_mode',
        'payment_reference', 'description', 'amount_received','amount_received_usd','amount_received_lbp','exchangerate',
        'payment_option_id'
    ];
