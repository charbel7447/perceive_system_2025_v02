            ...
            <form action="/login" method="POST" class="login-form">
               ...
               <div class="col-md-2" style="background: #ffffff87;padding: 10px 0 5px 45px;">
                  ...
                  <div class="wrap-input">
                     ...
                     <small class="error-control"><?php echo e($errors->first('email')); ?></small>
                     <?php endif; ?>
                  </div>
                  <div class="wrap-input">
                     ...
                     <small class="error-control"><?php echo e($errors->first('password')); ?></small>
                     <?php endif; ?>
                  </div>
...
</style><?php /**PATH C:\xampp\htdocs\perceive_system_2025_v02\resources\views/login.blade.php ENDPATH**/ ?>