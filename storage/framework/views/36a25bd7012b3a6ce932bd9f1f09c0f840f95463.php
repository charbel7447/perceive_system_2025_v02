...
<div class="min-h-screen bg-gray-100 py-8">
    ...
    <div class="max-w-7xl mx-auto bg-white shadow rounded-2xl p-6 border border-gray-200 mb-6">
        <form method="GET" action="<?php echo e(route('balance.sheet')); ?>" class="flex flex-wrap items-end gap-4">
            <div class="flex-1">
            ...
            <div>
                ...
                <input type="text" name="acc_from" id="accFrom" value="<?php echo e(request('acc_from')); ?>"
            ...
            <div>
                ...
                <input type="text" name="acc_to" id="accTo" value="<?php echo e(request('acc_to')); ?>"
...
<div class="flex flex-wrap gap-3 mt-2">
    ...
    <!-- Reset Button -->
    <a href="<?php echo e(route('balance.sheet')); ?>"
                ...
                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden class-block">
                        <div class="bg-gradient-to-r from-indigo-100 via-blue-100 to-indigo-200 p-4 border-b border-gray-300">
                            <h3 class="text-lg font-semibold text-gray-800"><?php echo e($class->code); ?> — <?php echo e($class->name_en); ?> / <?php echo e($class->name_ar); ?></h3>
                        </div>
                        ...
                        <div class="overflow-x-auto table-container">
                            <table class="w-full border-collapse">
                                ...
                                <tbody class="text-gray-700 text-sm">
                                    <?php $__currentLoopData = $filteredAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $items = $account->journalItems;
                                            if(request('from')) $items = $items->filter(fn($i)=>$i->voucher && $i->voucher->date >= request('from'));
                                            if(request('to'))   $items = $items->filter(fn($i)=>$i->voucher && $i->voucher->date <= request('to'));
                                        ...
                                        <tr class="hover:bg-blue-50 cursor-pointer transition account-row"
                                            ...
                                            data-code="<?php echo e(strtolower($account->code ?? '')); ?>"
                                            data-name="<?php echo e(strtolower(($account->name_en ?? '').' / '.($account->name_ar ?? ''))); ?>"
                                            data-debit="<?php echo e($debit); ?>" data-credit="<?php echo e($credit); ?>" data-balance="<?php echo e($balance); ?>"
                                            onclick="document.getElementById('acc<?php echo e($account->id); ?>').classList.toggle('hidden')">
                                            <td class="p-3 font-mono code-cell" data-original="<?php echo e($account->code); ?>"><?php echo e($account->code); ?></td>
                                            <td class="p-3 name-cell" data-original="<?php echo e($account->name_en); ?> / <?php echo e($account->name_ar); ?>"><?php echo e($account->name_en); ?> / <?php echo e($account->name_ar); ?></td>
                                            <td class="p-3 text-right text-green-700 font-medium"><?php echo e(number_format($debit,2)); ?></td>
                                            <td class="p-3 text-right text-red-700 font-medium"><?php echo e(number_format($credit,2)); ?></td>
                                            <td class="p-3 text-right font-semibold <?php echo e($balance >=0?'text-green-800':'text-red-800'); ?>"><?php echo e(number_format($balance,2)); ?></td>
                                        </tr>

                                        <tr id="acc<?php echo e($account->id); ?>" class="hidden bg-gray-50 detail-row">
                                                ...
                                                <table class="w-full ml-4 border-l-4 border-blue-300 text-xs">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr class="hover:bg-gray-100 cursor-pointer" onclick="openJV('<?php echo e(url('/docs/journal_vouchers/'.$item->journal_voucher_id)); ?>')">
                                                                <td><?php echo e($item->voucher->number ?? ''); ?></td>
                                                                <td><?php echo e($item->voucher->date ?? ''); ?></td>
                                                                <td><?php echo e($item->description); ?></td>
                                                                <td class="text-right"><?php echo e(number_format($item->debit,2)); ?></td>
                                                                <td class="text-right"><?php echo e(number_format($item->credit,2)); ?></td>
                                                            </tr>
                                    ...
                                    <tr class="bg-blue-50 font-bold border-t border-blue-200 class-subtotal">
                                        <td colspan="2" class="p-3 text-right">Subtotal (<?php echo e($class->name_en); ?> / <?php echo e($class->name_ar); ?>)</td>
                                        <td class="p-3 text-right text-green-700 subtotal-debit"><?php echo e(number_format($subtotalDebit,2)); ?></td>
                                        <td class="p-3 text-right text-red-700 subtotal-credit"><?php echo e(number_format($subtotalCredit,2)); ?></td>
                                        <td class="p-3 text-right text-blue-800 subtotal-balance"><?php echo e(number_format($subtotalBalance,2)); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <table class="w-full border-collapse">
                            <tbody>
                                <tr class="bg-green-50 font-bold">
                                    ...
                                    <td class="p-3 text-right text-green-700" id="grandDebit"><?php echo e(number_format($grandDebit,2)); ?></td>
                                    <td class="p-3 text-right text-red-700" id="grandCredit"><?php echo e(number_format($grandCredit,2)); ?></td>
                                    <td class="p-3 text-right text-blue-800" id="grandBalance"><?php echo e(number_format($grandBalance,2)); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
</style><?php /**PATH C:\xampp\htdocs\perceive_system_2025_v02\resources\views/balance_sheet/index.blade.php ENDPATH**/ ?>