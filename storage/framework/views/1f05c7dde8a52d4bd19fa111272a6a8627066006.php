    ...
    <div class="bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
        ...
        <div class="flex items-start justify-between gap-3 mb-4">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('profit_loss.exportExcel', request()->all())); ?>"
                   class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">⬇️ Export Excel</a>
                <a href="<?php echo e(route('profit_loss.exportPdf', request()->all())); ?>"
                   class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">⬇️ Export PDF</a>
                <a href="<?php echo e(route('profit_loss.index')); ?>"
                   class="bg-gray-400 text-white px-4 py-2 rounded-lg hover:bg-gray-500">❌ Clear</a>
            </div>
        </div>

        <!-- Filters -->
        <form method="GET" action="<?php echo e(route('profit_loss.index')); ?>" class="flex flex-wrap gap-4 mb-6">
            <div>
            ...
            <div class="min-w-[260px]">
                ...
                <select id="accountSelect" name="account_id" class="w-full border rounded-lg">
                    ...
                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <optgroup label="<?php echo e($class->name_en); ?>">
                            <?php $__currentLoopData = $class->accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($acc->id); ?>" <?php echo e(($account_id == $acc->id) ? 'selected' : ''); ?>>
                                    <?php echo e($acc->code); ?> - <?php echo e($acc->name_en); ?>
        ...
        <div class="flex gap-4 relative">
            ...
            <div :class="selectedAccount ? 'w-2/3 transition-all duration-500' : 'w-full transition-all duration-500'">
                <?php $__currentLoopData = ['4','6','5','7']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($report['classes'][$code]) && !empty($report['classes'][$code]['accounts'])): ?>
                        <?php $groupTotal = $report['classes'][$code]['subtotal']; ?>
                        ...
                        <div x-data="{ open: true }" class="mb-6 border rounded-lg">
                            <h3 @click="open = !open"
                                ...
                                <span><?php echo e($classes->where('code', $code)->first()->name_en ?? ($classMap[$code] ?? $code)); ?></span>
                            ...
                            <div x-show="open" class="overflow-x-auto rounded-b-lg border-t border-gray-200">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $report['classes'][$code]['accounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr @click="$dispatch('account-selected', <?php echo e($a['id']); ?>)"
                                                class="hover:bg-gray-50 cursor-pointer">
                                                <td class="border px-2 py-1"><?php echo e($a['code']); ?> - <?php echo e($a['name']); ?></td>
                                                <td class="border px-2 py-1 text-right"><?php echo e(number_format($a['amount'], 2)); ?></td>
                                                <td class="border px-2 py-1 text-right">
                                                    <?php echo e($groupTotal != 0 ? number_format(($a['amount'] / $groupTotal) * 100, 2) : '0.00'); ?>%
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="bg-green-50 font-medium">
                                            <td class="border px-2 py-1 text-right">Subtotal – <?php echo e($classMap[$code]); ?></td>
                                            <td class="border px-2 py-1 text-right"><?php echo e(number_format($groupTotal, 2)); ?></td>
                ...
                <ul>
                    <template x-for="doc in docs" :key="doc.id">
                        <li class="border-b py-1 flex justify-between items-center">
                            ...
                            <a :href="'<?php echo e(url('/')); ?>/journal_vouchers/' + doc.id" target="_blank"
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <div class="text-2xl font-bold text-green-700"><?php echo e(number_format($report['total_income'], 2)); ?></div>
            </div>
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="text-sm text-red-700 font-semibold">Total Expenses</div>
                <div class="text-2xl font-bold text-red-700"><?php echo e(number_format($report['total_expense'], 2)); ?></div>
            </div>
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="text-sm text-blue-700 font-semibold">Net Profit</div>
                <div class="text-2xl font-bold text-blue-700"><?php echo e(number_format($report['net_profit'], 2)); ?></div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\perceive_system_2025_v02\resources\views/profit_loss/index.blade.php ENDPATH**/ ?>