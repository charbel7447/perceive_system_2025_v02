...
<div class="flex flex-col md:flex-row gap-4 relative overflow-hidden">
    ...
    <div id="leftCol" class="w-full transition-all">
        <div class="bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
            ...
            <!-- Filters -->
            <form method="GET" action="<?php echo e(route('general_ledger.index')); ?>" class="flex flex-wrap gap-4 mb-6">
                <div>
            ...
            <!-- Ledger Report -->
            <?php $__currentLoopData = $ledgerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classCode => $accounts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <h3 class="text-xl font-semibold mt-6 mb-2 border-b pb-1 text-gray-700">
                    <?php echo e($classes->where('code',$classCode)->first()->name_en); ?>
                ...
                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-6">
                        <h4 class="text-lg font-bold text-gray-800 mb-2">
                            <?php echo e($acc['account']->code); ?> - <?php echo e($acc['account']->name_en); ?>
                        ...
                        <div class="overflow-x-auto rounded-lg border border-gray-200">
                            <table class="w-full text-sm">
                                ...
                                <tr class="bg-yellow-50 font-medium">
                                    ...
                                    <td class="text-right px-2 py-1"><?php echo e(number_format($acc['opening'], 2)); ?></td>
                                </tr>
                                <?php $__empty_1 = true; $__currentLoopData = $acc['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="border px-2 py-1"><?php echo e($row['date']); ?></td>
                                        <td class="border px-2 py-1">
                                            <a href="javascript:void(0)"
                                               onclick="openJV('<?php echo e(url('/docs/journal_vouchers/'.$row['voucher_id'])); ?>')"
                                               class="text-blue-600 hover:underline">
                                                <?php echo e($row['voucher_no']); ?>

                                            </a>
                                        </td>
                                        <td class="border px-2 py-1"><?php echo e($row['description']); ?></td>
                                        <td class="border px-2 py-1 text-right"><?php echo e(number_format($row['debit'], 2)); ?></td>
                                        <td class="border px-2 py-1 text-right"><?php echo e(number_format($row['credit'], 2)); ?></td>
                                        <td class="border px-2 py-1 text-right"><?php echo e(number_format($row['balance'], 2)); ?></td>
                                    </tr>
                                ...
                                <tr class="bg-green-50 font-medium">
                                    ...
                                    <td class="text-right px-2 py-1"><?php echo e(number_format($acc['closing'], 2)); ?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\perceive_system_2025_v02\resources\views/general_ledger/index.blade.php ENDPATH**/ ?>