...
<div id="app" class="p-5">
  ...
  <a style="background:#000;" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl   text-white shadow transition"
          href="<?php echo e(url('/')); ?>/dashboard/custom_layout/<?php echo e($dashboard_id); ?>/delete">
...
data() {
  return {
    ...
    search: '',
    library: [],
    user_dashboard_id: '<?php echo e($dashboard_id ?? 0); ?>',
  };
},
computed: {
  filteredWidgets() {
...
<?php /**PATH C:\xampp\htdocs\perceive_system_2025_v02\resources\views/custom_layout.blade.php ENDPATH**/ ?>